...
Widget wrapWithModel<T extends FinWalletModel>({
  required T model,
...
T createModel<T extends FinWalletModel>(
...
class FinWalletDynamicModels<T extends FinWalletModel> {
  FinWalletDynamicModels(this.defaultBuilder);
