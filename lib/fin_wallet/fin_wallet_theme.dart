...
abstract class FinWalletTheme {
  ...
  static FinWalletTheme of(BuildContext context) {
...
class LightModeTheme extends FinWalletTheme {
  @Deprecated('Use primary instead')
  Color get primaryColor => primary;
  @Deprecated('Use secondary instead')
  Color get secondaryColor => secondary;
...
class DarkModeTheme extends FinWalletTheme {
  @Deprecated('Use primary instead')
  Color get primaryColor => primary;
  @Deprecated('Use secondary instead')
  Color get secondaryColor => secondary;
