...
final kTranslationsMap = <Map<String, Map<String, String>>>[
  ...
  // onboarding
  {
    ...
    'hxtwax0y': {
      'en':
          'Add cards that you can tie transactions too in order for easy tracking.',
      'ar':
          'أضف بطاقات يمكنك ربط المعاملات بها أيضًا لتسهيل التتبع.',
      'de':
          'Fügen Sie Karten hinzu, mit denen Sie auch Transaktionen verknüpfen können, um die Nachverfolgung zu erleichtern.',
      'es':
          'Agregue tarjetas con las que también pueda vincular transacciones para facilitar el seguimiento.',
    },
    'mjy3ljln': {
    ...
    'ypt7b97g': {
      'en': 'Add a card to conitue',
      'ar': 'أضف بطاقة للمتابعة',
      'de': 'Fügen Sie eine Karte hinzu, um fortzufahren',
      'es': 'Añade una tarjeta para continuar',
    },
    'oo0kk9qe': {
      'en': 'Home',
      'ar': 'مسكن',
